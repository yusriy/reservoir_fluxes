...
data <- cbind(data,cold_front,windy,n_windy)
rm(cold_front,windy,n_windy) # Deleting temporary variable
...
plot(neg$deltaE[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste(Delta,'e')),ylab='LE',xlim=c(-0.8,0),ylim=c(-90,40),cex.lab=2.2,cex.axis=2.2)
text(-0.80,40,'a)',cex=2.2)
...
plot(neg$WS_Spd_WVT[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab='U',ylab='LE',xlim=c(0,14),ylim=c(-90,40),cex.lab=2.2,cex.axis=2.2)
text(0,40,'b)',cex=2.2)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(neg$u_deltaE[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste('U',Delta,'e')),ylab='LE',xlim=c(-5,0),ylim=c(-90,40),cex.lab=2.2,cex.axis=2.2)
text(-5,40,'c)',cex=2.2)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
##### 5A1. Fig. r H (with regressions): In "Latent heat flux and stability" paper ####
...
# Path where the plots will be saved
path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_2a.jpg')
jpeg(file=path_fig,width=3060, height=3600,res=360)
## Creating 6 panels of plots
plot.new()
par(mfrow=c(3,2),mar=c(4.1,4.5,2.1,1.1),family='Times')
...
plot(neg$deltaT[which(neg$Z.L<0)],neg$H[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste(Delta,'T')),ylab='H',xlim=c(-12,0),ylim=c(-150,55),cex.lab=2.1,cex.axis=2.1)
text(-12,55,'a)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
points(neg$deltaT[which(neg$Z.L>0)],neg$H[which(neg$Z.L>0)],pch=19, col='blue')
abline(lm1,col='red',lwd=3)
abline(lm2,col='blue',lty=2,lwd=3)
axis(side=2,at=c(0,-100),cex.axis=2.1)

## Plotting H against deltaT for positive deltaT values
plot(pos$deltaT[which(pos$Z.L<0)],pos$H[which(pos$Z.L<0)],pch=17,col='red',
     xlab=expression(paste(Delta,'T')),ylab='',xlim=c(0,12),ylim=c(-80,250),cex.lab=2.1,cex.axis=2.1)
text(0,250,'d)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(neg$WS_Spd_WVT[which(neg$Z.L<0)],neg$H[which(neg$Z.L<0)],pch=17,col='red',
     xlab='U',ylab='H',xlim=c(0,14),ylim=c(-150,55),cex.lab=2.1,cex.axis=2.1)
text(0,50,'b)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(pos$WS_Spd_WVT[which(pos$Z.L<0)],pos$H[which(pos$Z.L<0)],pch=17,col='red',
     xlab='U',ylab='',ylim=c(-80,250),xlim=c(0,14),cex.lab=2.1,cex.axis=2.1)
text(0,250,'e)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(neg$u_deltaT[which(neg$Z.L<0)],neg$H[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste('U',Delta,'T')),ylab='H',xlim=c(-10,0),ylim=c(-150,55),cex.lab=2.1,cex.axis=2.1)
text(-10,55,'c)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(pos$u_deltaT[which(pos$Z.L<0)],pos$H[which(pos$Z.L<0)],pch=17,col='red',
     xlab=expression(paste('U',Delta,'T')),ylab='',ylim=c(-80,250),xlim=c(0,125),cex.lab=2.1,cex.axis=2.1)
text(0,250,'f)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot1 <- ggplot(na.omit(data[,c('LE','stability_no')]), aes(factor(stability_no),LE)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  labs(x="",y="LE") + theme_bw() + annotate("text",x=0.8,y=450,label="a)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        ...
        plot.margin=unit(c(1,1,4,-1.2),"mm")) + 
...
plot2 <- ggplot(na.omit(data[,c('deltaE','stability_no')]), aes(factor(stability_no),deltaE)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste(Delta,'e'))) + theme_bw() + annotate("text",x=0.8,y=3,label="b)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
...
plot3 <- ggplot(na.omit(data[,c('WS_Spd_WVT','stability_no')]), aes(factor(stability_no),WS_Spd_WVT)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y='U') + theme_bw() + annotate("text",x=0.8,y=14,label="c)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
        plot.margin=unit(c(-17,1,26,3),"mm")) + 
  scale_y_continuous(breaks=seq(0,14,by=5),limits=c(0,14)) +
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue'))  
# d) U delta E
plot4 <- ggplot(na.omit(data[,c('u_deltaE','stability_no')]), aes(factor(stability_no),u_deltaE)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste('U',Delta,'e'))) + theme_bw() + annotate("text",x=0.8,y=14.1,label="d)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.x=element_text(size=16,family='Times'),axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_text(angle=90,size=16,vjust=1,family='Times'),axis.text.y=element_text(size=16,family='Times'),
        plot.margin=unit(c(-31,1,7,3),"mm")) + 
...
#### 5B1. Fig. 5 Arrows of LE with deltaE, U, etc ###########
# Path where the plots will be saved
...
##### 5Ba. Fig. 3a: H, deltaT, u_deltaT versus atmospheric stability category ####

# Path where the plots will be saved
path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_3a.jpg')
jpeg(file=path_fig,width=5, height=10,res=360,units='in')
...
plot1 <- ggplot(na.omit(data[,c('H','stability_no')]), aes(factor(stability_no),H)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x="",y="H") + theme_bw() + annotate("text",x=0.8,y=300,label="a)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
        plot.margin=unit(c(1,1,4,-1.2),"mm")) + 
  scale_y_continuous(breaks=seq(-100,300,by=100)) + 
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue'))
...
plot2 <- ggplot(na.omit(data[,c('deltaT','stability_no')]), aes(factor(stability_no),deltaT)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste(Delta,'T'))) + theme_bw() + annotate("text",x=0.8,y=12,label="b)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
...
plot4 <- ggplot(na.omit(data[,c('u_deltaT','stability_no')]), aes(factor(stability_no),u_deltaT)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste('U',Delta,'T'))) + theme_bw() + annotate("text",x=0.8,y=120,label="d)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.x=element_text(size=16,family='Times'),axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_text(angle=90,size=16,vjust=1,family='Times'),axis.text.y=element_text(size=16,family='Times'),
        plot.margin=unit(c(-31,1,7,3),"mm")) + 
...
##### 5Ba1. Fig. 3b: arrows for H #################
# Path where the plots will be saved
path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_Hnew.jpg')
jpeg(file=path_fig,width=1346, height=3600,res=360)
## Creating 6 panels of plots
plot.new()
par(mfrow=c(3,1),mar=c(4.1,4.6,1,1.1),family='Times')

#Figure 5 a) H and deltaT
...
axis(side=2,at=c(-20,0,20,40),cex.axis=2.2)
text(-4,50,'a)',cex=2.2)
text(-3,-15,'stable',cex=2)
text(1,0,'near-neutral',cex=2)
text(3,45,'unstable',cex=2)
...
axis(side=2,at=c(-20,0,20,40),cex.axis=2.2)
text(0,50,'b)',cex=2.2)
text(3.8,-15,'stable',cex=2)
text(3.4,5,'near-neutral',cex=2)
text(4,45,'unstable',cex=2)
...
axis(side=2,at=c(-20,0,20,40),cex.axis=2.2)
text(-20,50,'c)',cex=2.2)
text(-10,-15,'stable',cex=2)
text(8,0,'near-neutral',cex=2)
text(15,45,'unstable',cex=2)
...
##### 5Ba2. Fig. 10: r2 for H ############

# Path where the plots will be saved
path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_HRnew.jpg')
jpeg(file=path_fig,width=5, height=10,res=360,units='in')
## Creating a new plot
plot.new()
#regression R^2 results plot between LE and U
plot7 <- ggplot(data=data_rsq2,aes(x=cat_no,y=r_H_U)) +
  ...
  annotate('text', x = 0.8, y = 1, label='a)',family='Times') # LE and U')

#regression R^2 results plot between LE and deltaE
plot8 <- ggplot(data=data_rsq2,aes(x=cat_no,y=r_H_dT)) +
  geom_bar(stat='identity',fill='white',color='black',position='identity') +
  xlab('') + ylab(expression(paste('r'^'2'))) + ylim(-0.05,1.0) +
  theme(axis.title.y=element_text(size=16,family='Times'),
  ...
  annotate('text', x = 0.8, y = 1, label= 'b)',family='Times') #expression(paste('b) LE and ',Delta,'e')))

#regression R^2 results plot between LE and deltaE
plot9 <- ggplot(data=data_rsq2,aes(x=cat_no,y=r_H_UdT)) +
  geom_bar(stat='identity',fill='white',color='black',position='identity') +
  xlab('') + ylab(expression(paste('r'^'2'))) + ylim(-0.05,1.0) +
  theme(axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_text(angle=90,size=16,vjust=1,color ='black',family='Times'), axis.text.y=element_text(size=16,color='black',family='Times'),
        panel.background=element_rect(fill='white',color='black'),
        plot.margin=unit(c(-28,2,10,0),"mm")) +
  scale_x_discrete(labels = names_boxplot) +
  annotate('text',x=0.8,y=1,label= 'c)',family='Times') #expression(paste('c) LE and ','U',Delta,'e')))

#Plotting all three above together in one plot
multiplot2(plot7,plot8,plot9,cols=1,labs=list('ASL stability ranges',''))
dev.off()

##### 5Bb. Fig. 3b: Some parameters Sept 2007 time series ####

path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_3b.jpg')
jpeg(file=path_fig,width=5,height=10,res=360,units='in')
...
axis(side=2,at=c(-1,0,0.5),cex.axis=2)
axis(side=2,at=c(-0.5),cex.axis=2)
text(0,0.45,'c)',cex=2)
...
##### 5C. Fig. 4: U and u* and u* for different ASL stability ranges ####
names_boxplot = c('-10\u2264\u03B6<-1','-1\u2264\u03B6<-0.5','-0.5\u2264\u03B6<-0.1','-0.1\u2264\u03B6<-0.05',
                  '-0.05\u2264\u03B6<0','0\u2264\u03B6<0.05','0.05\u2264\u03B6<0.1','0.1\u2264\u03B6<0.5','0.5\u2264\u03B6<1',
                  '1\u2264\u03B6<10')
# Path where the plots will be saved
...
plot6 <- ggplot(na.omit(data[,c('LE_U','stability_no')]), aes(factor(stability_no),LE_U)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=100,label="a)",family='Times',size=7)
...
plot6a <- ggplot(na.omit(data[,c('LE_deltaE','stability_no')]), aes(factor(stability_no),LE_deltaE)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),axis.title.x=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_text(angle=90,size=16,vjust=1,family='Times'),
        plot.margin=unit(c(-20,1,10,0),"mm")) + 
  scale_x_discrete(labels=names_boxplot) +
  scale_y_continuous(breaks=seq(-100,300,by=100),limits=c(-100,300)) + 
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=300,label="b)",family='Times',size=7)

multiplot2(plot6,plot6a,cols=1,labs=list('ASL stability ranges',''))
dev.off()

##### 5Da. Fig. 13: H/U and H/deltaE for different ASL stability ranges ####
names_boxplot = c('-10\u2264\u03B6<-1','-1\u2264\u03B6<-0.5','-0.5\u2264\u03B6<-0.1','-0.1\u2264\u03B6<-0.05',
                  '-0.05\u2264\u03B6<0','0\u2264\u03B6<0.05','0.05\u2264\u03B6<0.1','0.1\u2264\u03B6<0.5','0.5\u2264\u03B6<1',
                  '1\u2264\u03B6<10')
# Path where the plots will be saved
...
plot1 <- ggplot(na.omit(data[,c('H_U','stability_no')]), aes(factor(stability_no),H_U)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=50,label="a)",family='Times',size=7)
...
plot2 <- ggplot(na.omit(data[,c('H_deltaT','stability_no')]), aes(factor(stability_no),H_deltaT)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=30,label="b)",family='Times',size=7)
...
# Path where the plots will be saved
path_fig <- file.path('/Users/Yusri/Documents/Work/Data analysis/lake/figs/figs_V3/fig_6new.jpg')
jpeg(file=path_fig,width=5, height=10,res=360,units='in')
## Creating a new plot
plot.new()
#regression R^2 results plot between LE and U
...
#regression R^2 results plot between LE and deltaE
plot8 <- ggplot(data=data_rsq,aes(x=cat_no,y=rsquared_LE_deltaE)) +
  geom_bar(stat='identity',fill='white',color='black',position='identity') +
  xlab('') + ylab(expression(paste('r'^'2'))) + ylim(-0.05,1.0) +
  theme(axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_blank(), axis.text.y=element_text(size=16,color='black',family='Times'),
...
#regression R^2 results plot between LE and deltaE
plot9 <- ggplot(data=data_rsq,aes(x=cat_no,y=rsquared_LE_udeltaE)) +
  geom_bar(stat='identity',fill='white',color='black',position='identity') +
  xlab('') + ylab(expression(paste('r'^'2'))) + ylim(-0.05,1.0) +
  theme(axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_text(angle=90,size=16,vjust=1,color ='black',family='Times'), axis.text.y=element_text(size=16,color='black',family='Times'),
...
par(family='Times',mfrow=c(3,3),mar=c(4.1,5.1,1.1,1.1))

# Unstable (-0.5 < z/L < -0.1)
plot(data$WS_Spd_WVT[unstable],data$LE[unstable],xlab='',ylab='LE',pch=19,col='red',ylim=c(-100,450),xlim=c(0,15),cex.lab=2.2,cex.axis=2.2,xaxt='n',yaxt='n')
text(0.5,445,'a)',cex=2.2)
lm_U_unstable <- lm(LE[unstable]~WS_Spd_WVT[unstable],data=data)
abline(lm_U_unstable,col='red',lwd=2)
minor.tick(ny=2,nx=5,tick.ratio=0.5)
axis(side=2,at=c(0,200,400),cex.axis=2.2)



plot(data$deltaE[unstable],data$LE[unstable],xlab='',
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-1,3),col='red',cex.lab=2.2,xaxt='n',yaxt='n')
text(-0.8,445,'d)',cex=2.2)
...
plot(data$u_deltaE[unstable],data$LE[unstable],xlab='',
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-5,15),col='red',cex.lab=2.2,xaxt='n',yaxt='n')
text(-4.5,445,'g)',cex=2.2)
...
plot(data$WS_Spd_WVT[near_neutral],data$LE[near_neutral],xlab='',ylab='LE',pch=19,col='black',ylim=c(-100,450),xlim=c(0,15),cex.lab=2.2,cex.axis=2.2,xaxt='n',yaxt='n')
text(0.5,445,'b)',cex=2.2)
...
plot(data$deltaE[near_neutral],data$LE[near_neutral],xlab='',
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-1,3),col='black',cex.lab=2.2,xaxt='n',yaxt='n')
text(-0.8,445,'e)',cex=2.2)
...
plot(data$u_deltaE[near_neutral],data$LE[near_neutral],xlab='',
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-5,15),col='black',cex.lab=2.2,xaxt='n',yaxt='n')
text(-4.5,445,'h)',cex=2.2)
...
# Stable (0.1 < z/L < 0.5)
plot(data$WS_Spd_WVT[stable],data$LE[stable],xlab='U',ylab='LE',pch=19,col='blue',ylim=c(-100,450),xlim=c(0,15),cex.lab=2.2,cex.axis=2.2,yaxt='n')
text(0.5,445,'c)',cex=2.2)
...
plot(data$deltaE[stable],data$LE[stable],xlab=expression(paste(Delta,'e')),
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-1,3),col='blue',cex.lab=2.2,cex.axis=2.2,yaxt='n')
text(-0.8,445,'f)',cex=2.2)
...
plot(data$u_deltaE[stable],data$LE[stable],xlab=expression(paste('U',Delta,'e')),
     ylab='',pch=19,ylim=c(-100,450),xlim=c(-5,15),col='blue',cex.lab=2.2,cex.axis=2.2,yaxt='n')
text(-4.5,445,'i)',cex=2.2)
...
##### 5E. Fig. 14: CE and CH under different ASL stability ranges ####
names_boxplot = c('-10\u2264\u03B6<-1','-1\u2264\u03B6<-0.5','-0.5\u2264\u03B6<-0.1','-0.1\u2264\u03B6<-0.05',
                  '-0.05\u2264\u03B6<0','0\u2264\u03B6<0.05','0.05\u2264\u03B6<0.1','0.1\u2264\u03B6<0.5','0.5\u2264\u03B6<1',
                  '1\u2264\u03B6<10')
# Path where the plots will be saved
...
plot1 <- ggplot(na.omit(data[,c('C_E','stability_no')]), aes(factor(stability_no),C_E)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/25),aes(color=factor(stability_no))) + 
  ...
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        ...
        plot.margin=unit(c(1,1,12,2.5),"mm")) + 
  scale_x_discrete(labels='') +
  scale_y_continuous(breaks=seq(-0.003,0.005,by=0.0020),limits=c(-0.003,0.005)) + 
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=0.005,label="a)",family='Times',size=7)
...
plot2 <- ggplot(na.omit(data[,c('C_H','stability_no')]), aes(factor(stability_no),C_H)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  annotate("text",x=0.70,y=0.005,label="b)",family='Times',size=7)
...
jpeg(file=path_fig,width=5, height=14,res=360,units='in')
...
plot(data$WS_Spd_WVT[unstable],data$C_E[unstable],
     xlab='',ylab=expression('C'['E']),pch=19,col='red',xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2,xaxt='n')
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'a)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)

plot(data$WS_Spd_WVT[unstable],data$C_H[unstable],
     xlab='',ylab=expression('C'['H']),pch=19,col='red',xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2,xaxt='n')
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'d)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)

# Near-neutral (-0.05 < z/L < 0.05)
plot(data$WS_Spd_WVT[near_neutral],data$C_E[near_neutral],
     xlab='',ylab=expression('C'['E']),pch=19,xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2,xaxt='n')
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'b)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)

plot(data$WS_Spd_WVT[near_neutral],data$C_H[near_neutral],
     xlab='',ylab=expression('C'['H']),pch=19,xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2,xaxt='n')
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'e)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)

# Stable (0.1 < z/L < 0.5)
plot(data$WS_Spd_WVT[stable],data$C_E[stable],
     xlab='U',ylab=expression('C'['E']),pch=19,col='blue',xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2)
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'c)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)

plot(data$WS_Spd_WVT[stable],data$C_H[stable],
     xlab='U',ylab=expression('C'['H']),pch=19,col='blue',xlim=c(-1,15),cex.lab=2.2,ylim=c(-0.005,0.01),cex.axis=2.2)
lines(c(-5:20),rep(0.002,26),lty=2,lwd=2)
lines(rep(4,26),seq(-0.010,0.015,by=0.001),lwd=2)
text(-0.8,0.01,'f)',cex=2.2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)
