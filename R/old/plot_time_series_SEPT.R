...
# The day starts at 00:00 on Sept 1, 2007; i is number of days in the dataset
...
time_start = as.numeric(data$time_stamp[350])
time_step = 86400
...
for (i in 1:i) {
  ...
  path <- file.path("/Users/Yusri/Documents/Work/Data analysis/lake/figs/time_series_092007",
