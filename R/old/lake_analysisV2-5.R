...
plot(neg$deltaE[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste(Delta,'e')),ylab='LE',xlim=c(-0.8,0),ylim=c(-90,40),cex.lab=2.1,cex.axis=2.1)
text(-0.80,40,'a)',cex=2.1)
...
plot(pos$deltaE[which(pos$Z.L<0)],pos$LE[which(pos$Z.L<0)],pch=17,col='red',
     xlab=expression(paste(Delta,'e')),ylab='',xlim=c(0,3),ylim=c(-50,500),cex.lab=2.1,cex.axis=2.1)
text(0,500,'d)',cex=2.1)
...
plot(neg$WS_Spd_WVT[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab='U',ylab='LE',xlim=c(0,14),ylim=c(-90,40),cex.lab=2.1,cex.axis=2.1)
text(0,40,'b)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(pos$WS_Spd_WVT[which(pos$Z.L<0)],pos$LE[which(pos$Z.L<0)],pch=17,col='red',
     xlab='U',ylab='',ylim=c(-50,500),xlim=c(0,14),cex.lab=2.1,cex.axis=2.1)
text(0,500,'e)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(neg$u_deltaE[which(neg$Z.L<0)],neg$LE[which(neg$Z.L<0)],pch=17,col='red',
     xlab=expression(paste('U',Delta,'e')),ylab='LE',xlim=c(-5,0),ylim=c(-90,40),cex.lab=2.1,cex.axis=2.1)
text(-5,40,'c)',cex=2.1)
minor.tick(ny=2,nx=2,tick.ratio=0.5)
...
plot(pos$u_deltaE[which(pos$Z.L<0)],pos$LE[which(pos$Z.L<0)],pch=17,col='red',
     xlab=expression(paste('U',Delta,'e')),ylab='',ylim=c(-50,500),xlim=c(0,15),cex.lab=2.1,cex.axis=2.1)
text(0,500,'f)',cex=2.1)
minor.tick(ny=2,nx=5,tick.ratio=0.5)
...
plot1 <- ggplot(na.omit(data[,c('LE','stability_no')]), aes(factor(stability_no),LE)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  labs(x="",y="LE") + theme_bw() + annotate("text",x=1,y=450,label="a)",size=7,family='Times') +
...
plot2 <- ggplot(na.omit(data[,c('deltaE','stability_no')]), aes(factor(stability_no),deltaE)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste(Delta,'e'))) + theme_bw() + annotate("text",x=1,y=3,label="b)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
...
plot3 <- ggplot(na.omit(data[,c('WS_Spd_WVT','stability_no')]), aes(factor(stability_no),WS_Spd_WVT)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y='U') + theme_bw() + annotate("text",x=1,y=14,label="c)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
...
plot4 <- ggplot(na.omit(data[,c('u_deltaE','stability_no')]), aes(factor(stability_no),u_deltaE)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste('U',Delta,'e'))) + theme_bw() + annotate("text",x=1,y=14.1,label="d)",size=7,family='Times') +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
...
plot1 <- ggplot(na.omit(data[,c('H','stability_no')]), aes(factor(stability_no),H)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x="",y="H") + theme_bw() + annotate("text",x=1,y=300,label="a)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
        plot.margin=unit(c(1,1,4,-1.2),"mm")) + 
...
plot2 <- ggplot(na.omit(data[,c('deltaT','stability_no')]), aes(factor(stability_no),deltaT)) + geom_boxplot(outlier.size=0,fill="white") + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste(Delta,'T'))) + theme_bw() + annotate("text",x=1,y=12,label="b)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_blank(),
        plot.margin=unit(c(-8,1,20,1.2),"mm")) + 
  scale_y_continuous(breaks=seq(-15,15,by=5)) + 
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue'))

# c) U delta T
plot3 <- ggplot(na.omit(data[,c('u_deltaT','stability_no')]), aes(factor(stability_no),u_deltaT)) + geom_boxplot(outlier.size=0,fill='white') + 
  geom_jitter(alpha=I(1/32),aes(color=factor(stability_no))) + 
  stat_summary(fun.y="mean",colour='black',geom='text',label='---',size=7) + 
  labs(x='',y=expression(paste('U',Delta,'T'))) + theme_bw() + annotate("text",x=1,y=120,label="c)",family='Times',size=7) +
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.x=element_text(size=16,family='Times'),axis.title.y=element_text(size=16,family='Times'),
        axis.text.x=element_text(angle=90,size=16,vjust=1,family='Times'),axis.text.y=element_text(size=16,family='Times'),
        plot.margin=unit(c(-24,1,7,0.1),"mm")) + 
  scale_y_continuous(breaks=seq(-150,150,by=50)) +
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue')) +
  scale_x_discrete(labels=names_boxplot)

multiplot2(plot1,plot2,plot3,
           cols=1,labs=list("ASL stability ranges",""))
dev.off()
...
legend(20,220,y.intersp=0.8,bty='n',lty=c(1,2),lwd=c(2,2),c('LE','H'),cex=2)
...
text(0,5.8,'b)',cex=2)
legend(20,6.5,y.intersp=0.6,bty='n',lty=c(2,1,3),lwd=c(2,2,2),
...
legend(20,42,y.intersp=1,bty='n',lty=c(1,2),lwd=c(2,2),c(expression('T'['a']),expression('T'['s'])),cex=2)
minor.tick(ny=5,nx=5,tick.ratio=0.5)
text(0,39,'d)',cex=2)
...
plot10 <- ggplot(na.omit(data[,c('C_E','stability_no')]), aes(factor(stability_no),C_E)) + geom_boxplot(outlier.size=0,fill="white") + 
  ...
  theme(legend.position='none',panel.grid.major=element_line(size=0),panel.grid.minor=element_line(size=0),
        axis.title.y=element_text(size=16,family='Times'),axis.title.x=element_text(size=16,family='Times'),
        axis.text.y=element_text(size=16,family='Times'),axis.text.x=element_text(angle=90,size=16,vjust=1,color ='black',family='Times')) + 
  scale_x_discrete(labels=names_boxplot) +
  scale_y_continuous(breaks=seq(0,0.005,by=0.0010),limits=c(0,0.005)) + 
  scale_color_manual(values=c('red','red','red','red','red','blue','blue','blue','blue','blue'))
plot10
dev.off()
...
plot.new()
# Plots of near neutral,stable,unstable conditions
par(family='Times',mfrow=c(3,1),mar=c(4.1,4.8,1.5,1.1))
# Unstable (-0.5 < z/L < -0.1)
